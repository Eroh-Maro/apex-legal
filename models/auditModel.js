...
auditSchema.pre(["updateOne", "findOneAndUpdate", "findByIdAndUpdate", "updateMany"], function () {
  throw new Error("Audit logs are immutable and cannot be modified.");
});

auditSchema.pre(["deleteOne", "findOneAndDelete", "findByIdAndDelete", "deleteMany"], function () {
